...
import { addVector, Vector, multVector, normalizeVector, lerpVector, subVector, magnitudeVector } from "./helpers.js";
...
class Player extends GameObject {
    ...
    onUpdate = (delta: number) => {
        ...
        const dir = subVector(camPos, this.position);
        const vec = addVector(this.position, (multVector(normalizeVector(dir), distance)) as Vector);
